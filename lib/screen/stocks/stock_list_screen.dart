...
class StockListScreen extends StatefulWidget {
  final String url;
  const StockListScreen({super.key, required this.url});
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: ClipRRect(
          ...
          child: Obx(() {
            if (stockController.fechStockLoading.value) {
              return Container(
                height: 200,
                child: const Center(
                  child: Column(
            ...
            if (stockController.getStocks.isEmpty) {
              return Container(
                height: 200,
                child: const Center(
                  child: Column(
            ...
            // Get the first stock for the fixed row
            final firstStock = stockController.getStocks.first;
            // Get the remaining stocks for the scrollable area
            final remainingStocks = stockController.getStocks.skip(1).toList();
                    ...
                    children: [
                      ...
                      Expanded(
                        child: SingleChildScrollView(
                          ...
                          child: Row(
                            children: [
                              _buildHeaderCell(firstStock.price, colWidth),
                              _buildHeaderCell(
                                  firstStock.changePercent, colWidth),
                              _buildHeaderCell(firstStock.volume, colWidth),
                              _buildHeaderCell(
                                  firstStock.relativeVolume, colWidth),
                              _buildHeaderCell(firstStock.marketCap, colWidth),
                              _buildHeaderCell(firstStock.peRatio, colWidth),
                              _buildHeaderCell(firstStock.epsDilTTM, colWidth),
                              _buildHeaderCell(
                                  firstStock.epsDilGrowthYoY, colWidth),
                              _buildHeaderCell(
                                  firstStock.dividendYield, colWidth),
                              _buildHeaderCell(firstStock.sector, colWidth),
                            ],
                          ),
                        ),
                      ),
                  ...
                  child: Row(
                    children: [
                      ...
                      SingleChildScrollView(
                        ...
                        child: Column(
                          children:
                              remainingStocks.asMap().entries.map((entry) {
                            final i = entry.key;
                              ...
                              decoration: BoxDecoration(
                                ...
                                border: Border(
                                  right: const BorderSide(
                                      color: Color(0xFF2C2C2E), width: 1.0),
                                  bottom: BorderSide(
                                    color: i == remainingStocks.length - 1
                                        ? Colors.transparent
                            ...
                            child: Column(
                              children:
                                ...
                                return Container(
                                  ...
                                  child: Row(
                                    children: [
                                      _buildDataCell(stock.price, colWidth, i),
                                      _buildChangeCell(
                                          stock.changePercent, colWidth, i),
                                      _buildDataCell(stock.volume, colWidth, i),
                                      _buildDataCell(
                                          stock.relativeVolume, colWidth, i),
                                      _buildDataCell(
                                          stock.marketCap, colWidth, i),
                                      _buildDataCell(
                                          stock.peRatio, colWidth, i),
                                      _buildDataCell(
                                          stock.epsDilTTM, colWidth, i),
                                      _buildDataCell(
                                          stock.epsDilGrowthYoY, colWidth, i),
                                      _buildDataCell(
                                          stock.dividendYield, colWidth, i),
                                      _buildDataCell(stock.sector, colWidth, i),
                                    ],
                                  ),
                                );
                              }).toList(),
