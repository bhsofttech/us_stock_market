...
class _FuturesScreenState extends State<FuturesScreen> {
  ...
  void initState() {
    ...
    // stockController
    //     .fetchFutures("https://in.tradingview.com/markets/futures/quotes-all/");
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SnapHelperWidget(
        ...
        onSuccess: (data) {
          // Get the first index for the fixed row
          final firstIndex = data.first;
          // Get the remaining indices for the scrollable area
