...
class EconomyScreen extends StatefulWidget {
  final String type;
  const EconomyScreen({super.key, required this.type});
...
class _EconomyScreenState extends State<EconomyScreen> {
  ...
  void initState() {
    super.initState();
    stockController.loadEconomy(
        "https://in.tradingview.com/markets/world-economy/countries/united-states/?category=gdp");
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SnapHelperWidget(
          future: stockController.economyFuture.value,
            ...
            child: Center(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    "Loading ${widget.type.toLowerCase()} data...", // Updated text to reflect ETF
                    style: const TextStyle(
