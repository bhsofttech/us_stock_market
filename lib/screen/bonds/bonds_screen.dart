      ...
      body: Container(
        ...
        child: ClipRRect(
          ...
          child: Obx(() {
            ...
            // Get the first bond for the fixed row
            final firstIndex = stockController.getBonds.first;
            // Get the remaining bonds for the scrollable area
            final remainingIndices = stockController.getBonds.skip(1).toList();
                    ...
                    children: [
                      ...
                      Expanded(
                        child: SingleChildScrollView(
                          ...
                          child: Row(
                            children: [
                              _buildHeaderCell(firstIndex.price, colWidth),
                              _buildHeaderCell(
                                  firstIndex.changePercent, colWidth),
                              _buildHeaderCell(firstIndex.volume, colWidth),
                              _buildHeaderCell(
                                  firstIndex.relativeVolume, colWidth),
                              _buildHeaderCell(firstIndex.marketCap, colWidth),
                              _buildHeaderCell(firstIndex.peRatio, colWidth),
                              _buildHeaderCell(firstIndex.epsDilTTM, colWidth),
                              _buildHeaderCell(
                                  firstIndex.epsDilGrowthYoY, colWidth),
                              _buildHeaderCell(
                                  firstIndex.dividendYield, colWidth),
                              _buildHeaderCell(firstIndex.sector, colWidth),
                            ],
                          ),
                        ),
                      ),
                  ...
                  child: Row(
                    children: [
                      ...
                      SingleChildScrollView(
                        ...
                        child: Column(
                          children:
                              remainingIndices.asMap().entries.map((entry) {
                            final i = entry.key;
                              ...
                              decoration: BoxDecoration(
                                ...
                                border: Border(
                                  right: const BorderSide(
                                      color: Color(0xFF2C2C2E), width: 1.0),
                                  bottom: BorderSide(
                                    color: i == remainingIndices.length - 1
                                        ? Colors.transparent
                            ...
                            child: Column(
                              children:
                                ...
                                return Container(
                                  ...
                                  child: Row(
                                    children: [
                                      _buildDataCell(index.price, colWidth, i),
                                      _buildDataCell(
                                          index.changePercent, colWidth, i),
                                      _buildDataCell(index.volume, colWidth, i),
                                      _buildDataCell(
                                          index.relativeVolume, colWidth, i),
                                      _buildDataCell(
                                          index.marketCap, colWidth, i),
                                      _buildDataCell(
                                          index.peRatio, colWidth, i),
                                      _buildDataCell(
                                          index.epsDilTTM, colWidth, i),
                                      _buildDataCell(
                                          index.epsDilGrowthYoY, colWidth, i),
                                      _buildDataCell(
                                          index.dividendYield, colWidth, i),
                                      _buildDataCell(index.sector, colWidth, i),
                                    ],
                                  ),
                                );
                              }).toList(),
