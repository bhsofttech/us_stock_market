...
class EUGasolinePriceScreen extends StatefulWidget {
  const EUGasolinePriceScreen({super.key});

  @override
  State<EUGasolinePriceScreen> createState() => _EUGasolinePriceScreenState();
}

class _EUGasolinePriceScreenState extends State<EUGasolinePriceScreen>
    ...
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        child: AppBar(
          ...
          centerTitle: true,
          title: Text(
            "Europe Gasoline Prices".toUpperCase(),
            style: TextStyle(
              color: primaryBlue,
  ...
  Widget _buildGasolinePriceContent() {
    return FadeTransition(
      opacity: _fadeAnimation,
      child: _buildGasolinePriceList(),
    );
  }

  Widget _buildHeaderStats() {
    final highestPrice = _fuelController.getFuelInfo.isNotEmpty
        ? _fuelController.getFuelInfo.reduce((a, b) =>
            double.parse(a.gasoline) > double.parse(b.gasoline) ? a : b)
        : null;
  ...
  Widget _buildGasolinePriceList() {
    return Column(
            ...
            return Transform.translate(
              ...
              child: Opacity(
                ...
                child: Padding(
                  ...
                  child: _buildGasolinePriceCard(index),
                ),
              ),
            );
          },
  ...
  Widget _buildGasolinePriceCard(int index) {
    return Material(
              ...
              child: Row(
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      "£${_fuelController.getFuelInfo[index].gasoline}",
                      style: TextStyle(
                        fontFamily: 'SF Pro Text',
                        fontSize: 14,
                        fontWeight: FontWeight.w600,
